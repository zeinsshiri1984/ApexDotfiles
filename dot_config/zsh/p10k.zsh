# Generated by Powerlevel10k configuration wizard on 2026-01-03 at 09:55 +08.
...
() {
  ...
  # 多行前缀装饰（冰蓝渐变）
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%31F╭─'    # 深蓝绿
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%38F├─'  # 湖蓝
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%117F╰─'    # 天蓝
  # The left end of left prompt.
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%24F░%31F▒%38F▓%51F▓%87F█%51F▓%38F▓%31F▒%24F░'
  #ip内容和标识符配置
